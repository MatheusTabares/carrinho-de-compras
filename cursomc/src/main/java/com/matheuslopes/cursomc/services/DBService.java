...
import com.matheuslopes.cursomc.domain.PagamentoComBoleto;
import com.matheuslopes.cursomc.domain.PagamentoComCartao;
import com.matheuslopes.cursomc.domain.Pedido;
import com.matheuslopes.cursomc.domain.Produto;
import com.matheuslopes.cursomc.domain.enums.EstadoPagamento;
...
import com.matheuslopes.cursomc.reporitories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		produtoRepository.saveAll(Arrays.asList(p1, p2, p3, p5, p6, p7, p8, p9, p10));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "tabares.lopes@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "matheus.tabares@restinga.ifrs.edu.br", "10374652023", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("27361234", "93835869"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "38777013", cli2, c2);
